...
export interface ApiHandle<Payload, Result, _Headers> {
...
export interface ApiWithValidate<Payload, Result, _Headers> {
  (this: Context, payload: Payload, headers?: _Headers): Promise<Result> | Result
  [ID]: string
  [IDENTITY]: "api"
...
export const defineAPI = <Payload, Result, _Headers, Schema extends ZodType>(
